...
struct rtus_driver_t : public jit_generator {
    ...
    Xbyak_loongarch::XReg reg_ws = t0;
    Xbyak_loongarch::XReg reg_src = t1;
    Xbyak_loongarch::XReg reg_icb = t3;
    Xbyak_loongarch::XReg reg_os = t4;
    Xbyak_loongarch::XReg reg_iw_start = t5;

    Xbyak_loongarch::XReg reg_cur_os = t6;
    Xbyak_loongarch::XReg reg_cur_iw = t7;
    Xbyak_loongarch::XReg reg_cur_src = t8;
    Xbyak_loongarch::XReg reg_cur_src_fin = reg_cur_iw; /* just reuse */

    Xbyak_loongarch::XReg tail_mask = t2;

    // nspc section
    Xbyak_loongarch::XReg reg_cur_icb = t6;
    Xbyak_loongarch::XReg reg_tail_mask = a4;
    Xbyak_loongarch::XReg reg_icb_remainder = a5;
    Xbyak_loongarch::XReg reg_ws_copy = a6;
    ...
    //Xbyak::Xmm reg_zero;
    Xbyak_loongarch::XVReg reg_zero = Xbyak_loongarch::XVReg(0);
    //Xbyak::Xmm reg_v;
    Xbyak_loongarch::XVReg reg_v = Xbyak_loongarch::XVReg(1);
    ...
    void loop_is_nspc() {
        ...
        // this is loongarch load_bytes function
        //auto load_reg = [=](const VReg &vreg, const XReg &reg,
        ...
        // this is loongarch store_bytes function
...
#undef READ_PARAM
        ...
        if (!src_to_ws_) {
            switch (reg_zero.getBit() / 8) {
                ...
                case 32 /*ymm*/: {
                    Xbyak_loongarch::XVReg ymm_z(reg_zero.getIdx());
