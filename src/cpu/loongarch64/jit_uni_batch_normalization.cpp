...
*/
    ...
    void uni_xvldst_spat_data(const XVReg &xvreg, const XReg &r1, const XReg &r2, int32_t off, bool ldFlag) {
...
*/
    ...
    void uni_xvldst_maybe_tail(const XVReg &xvreg, const XReg &r1, bool ldFlag, const XReg &r2=zero int32_t off=0) {
