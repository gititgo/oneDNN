...
private:
    ...
    Xbyak_loongarch::XReg reg_bcast_data = t0;
    Xbyak_loongarch::XReg reg_load_data = t1;
    Xbyak_loongarch::XReg reg_output_data = t2;
    Xbyak_loongarch::XReg aux_reg_bcast_data = t3;
    Xbyak_loongarch::XReg aux1_reg_bcast_data = abi_not_param1;
    Xbyak_loongarch::XReg aux_reg_load_data = abi_param1;
    Xbyak_loongarch::XReg aux_reg_output_data = t4;
    Xbyak_loongarch::XReg reg_load_loop_work = t5;
    Xbyak_loongarch::XReg reg_bcast_loop_work = t6;
    Xbyak_loongarch::XReg reg_reduce_loop_work = t7;
    Xbyak_loongarch::XReg load_loop_iter = a6;
    Xbyak_loongarch::XReg bcast_loop_iter = a2;
    Xbyak_loongarch::XReg reduce_loop_iter = a3;
    Xbyak_loongarch::XReg imm_addr64 = reduce_loop_iter;
    Xbyak_loongarch::XReg reg_reduce_pos_flag = a4;
    Xbyak_loongarch::XReg reg_output_stride = a5;
    Xbyak_loongarch::XReg reg_bias_data = a5;
    Xbyak_loongarch::XReg reg_diff_bias_data = bcast_loop_iter;
    Xbyak_loongarch::XReg reg_tmp_output_stride = reg_bcast_data;
    Xbyak_loongarch::XReg reg_tmp = aux_reg_bcast_data;
    Xbyak_loongarch::XReg reg_output_stride_scale = load_loop_iter;
    ...
    Xbyak_loongarch::XVReg vreg_bcast = Xbyak_loongarch::XVReg(15);
    Xbyak_loongarch::XVReg vtmp = Xbyak_loongarch::XVReg(14);
