...
private:
    ...
    */
    ...
    using xreg_t = const Xbyak_loongarch::XReg;
    xreg_t reg_input = a4;
    ...
    Xbyak_loongarch::XVReg ytmp = Xbyak_loongarch::XVReg(14);
...
private:
    ...
    reg64_t aux_reg_kernel_oc_loop = abi_not_param1; // used in ndims < 5 case only 
