...
template struct jit_uni_dw_convolution_fwd_t<lasx, data_type::f32>;
//template struct jit_uni_dw_convolution_fwd_t<lsx, data_type::f32>;
...
template struct jit_uni_dw_convolution_bwd_data_t<lasx, data_type::f32>;
//template struct jit_uni_dw_convolution_bwd_data_t<lsx, data_type::f32>;
...
void jit_uni_dw_convolution_bwd_weights_t<lasx,
...
template struct jit_uni_dw_convolution_bwd_weights_t<lasx, data_type::f32>;
//template struct jit_uni_dw_convolution_bwd_weights_t<lsx, data_type::f32>;
} // namespace x64
} // namespace cpu
} // namespace impl
} // namespace dnnl
