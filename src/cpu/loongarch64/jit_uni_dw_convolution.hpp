...
#ifndef CPU_LOONGARCH64_JIT_UNI_DW_CONVOLUTION_HPP
#define CPU_LOONGARCH64_JIT_UNI_DW_CONVOLUTION_HPP
...
#include "cpu/loongarch64/jit_uni_dw_conv_kernel_utils.hpp"
...
using jit_lasx_dw_convolution_fwd_t
        = jit_uni_dw_convolution_fwd_t<lasx, data_type::f32>;
...
using jit_lasx_dw_convolution_bwd_data_t
        = jit_uni_dw_convolution_bwd_data_t<lasx, data_type::f32>;
...
using jit_lasx_dw_convolution_bwd_weights_t
        = jit_uni_dw_convolution_bwd_weights_t<lasx, data_type::f32>;
