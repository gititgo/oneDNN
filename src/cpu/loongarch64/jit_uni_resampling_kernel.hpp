...
private:
    ...
    //using Ymm = Xbyak::Ymm;
    //using Zmm = Xbyak::Zmm;
    using VReg = Xbyak_loongarch::VReg;
    using XVReg = Xbyak_loongarch::XVReg;
    //using Opmask = Xbyak::Opmask;
    //using Reg64 = Xbyak::Reg64;
    using Opmask = Xbyak_loongarch::XReg;
    using Reg64 = Xbyak_loongarch::XReg;
    ...
    const Opmask &k_tail_mask_ = s3;    //k3;
    const Opmask &k_full_mask_ = s4;    //k4;

    const Reg64 &reg_tmp_ = t0; //rax;    
    const Reg64 &reg_dst_ = a4; //rbx;
    const Reg64 &reg_work_ = a5;    //rdx;
    const Reg64 &reg_indices_ = a6; //rsi;
    const Reg64 &reg_c_offset = a7; //rbp;
    const Reg64 &reg_param = abi_param1;         //a0   
    const Reg64 &reg_weights = abi_not_param1;   //t8
    const Reg64 &reg_src_ = a3; //r8;
    const Reg64 &reg_aux_src_0_ = t1;   //r9;
    const Reg64 &reg_aux_src_1_ = t2;   //r10;
    const Reg64 &reg_aux_src_2_ = t3;   //r11;
    const Reg64 &reg_tmp1_ = t7;        //r15;
    ...
    const Reg64 &reg_src_btl_ = t4; //r12;
    const Reg64 &reg_src_btr_ = t5; //r13;
    const Reg64 &reg_src_bbl_ = t6; //r14;
    const Reg64 &reg_src_bbr_ = t7; //r15;
    ...
    static constexpr bool is_xmm_ = std::is_same<Vmm, Xbyak_loongarch::VReg>::value;
